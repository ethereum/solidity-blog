...
## New binaries released for Solidity 0.8.18
Due to x in our release process we needed to recompile the binaries for 0.8.18. 
In the following table you can confirm the new hashes for the specific binaries.
