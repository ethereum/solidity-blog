...
You can find the preview binaries at the following locations:
 ...
 - [soljson.js](https://github.com/ethereum/solidity/releases/download/preview-0.8.x/soljson.js)
 - [solc-macos](https://github.com/ethereum/solidity/releases/download/preview-0.8.x/solc-macos)
 - [solc-static-linux](https://github.com/ethereum/solidity/releases/download/preview-0.8.x/solc-static-linux)
 - [solc.exe](https://github.com/ethereum/solidity/releases/download/preview-0.8.x/solc.exe)
...
You can also try out the 0.8.x compiler in [Remix](https://remix.ethereum.org/#version=https://github.com/ethereum/solidity/releases/download/preview-0.8.x/soljson.js). If you use this link, the preview compiler is already selected.
