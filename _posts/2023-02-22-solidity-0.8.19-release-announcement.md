...
as the built-in types and promote the use of type-safe interfaces. All details, code examples and context on the design considerations on this feature can be found in the [this blogpost](https://blog.soliditylang.org/2023/02/22/user-defined-operators).
